...
const PEOPLE = [
  ...
  { name: 'Jenny Wen', handle: '@jenny_wen', platform: 'X', url: 'https://x.com/jenny_wen', annotation: 'Head of design at Claude. Best signal on the AI × design intersection.', annotation_cn: 'Claude 设计负责人。AI 与设计交叉领域的最佳信号源。', tags: ['Design', 'AI UX'] },
